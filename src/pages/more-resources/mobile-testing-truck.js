...
const MobileTestingTruck = () => {
  const doc = DOCUMENTS.find((d) => d.id === 14)
  ...
  return (
    <SiteLayout title={doc.title} pathname={`/more-resources/${doc.slug}`}>
      ...
      >
        ...
        <p>
          This document provides information on how to design and operate a
          customized vehicle for mobile testing. If you have any questions,
          please contact{' '}
...
export default MobileTestingTruck
